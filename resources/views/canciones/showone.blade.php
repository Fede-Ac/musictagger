            ...
            <div class="card ">
                ...
                <div class="row">
                    ...
                    <div class="col">
                        <ul class="list-group list-group-flush mr">
                            <li class="list-group-item">Título {{ collect($cancion[0])->get('TITULO', 'Desconocido') }}</li>
                            <li class="list-group-item">Artista {{ collect($cancion[0])->get('AUTOR', 'Desconocido') }}</li>
                            <li class="list-group-item">Etiqueta {{ collect($cancion[0])->get('ETIQUETAS', 'Desconocido') }}
                            </li>
                            <li class="list-group-item">Género {{ collect($cancion[0])->get('GENERO', 'Desconocido') }}</li>
                            <li class="list-group-item">Calificación
                                <span class="badge badge-pill badge-success">Me gusta
                                    {{ collect($cancion[0])->get('', 'Desconocido') }}</span>
                ...
                <div class="collapse show" id="collapseExample">
                    ...
                    <ul class="list-group list-group-flush mr">
                        <div class="row">
                            <div class="col">
                                <li class="list-group-item">Álbum {{ collect($cancion[0])->get('ALBUM', 'Desconocido') }}
                                </li>
                                <li class="list-group-item">Discográfica
                                    {{ collect($cancion[0])->get('DISCOGRAFICA', 'Desconocido') }}</li>
                                <li class="list-group-item">Año {{ collect($cancion[0])->get('AÑO', 'Desconocido') }}</li>
                            </div>
                            <div class="col">
