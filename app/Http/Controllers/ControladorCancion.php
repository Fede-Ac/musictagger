...
class ControladorCancion extends Controller
{
    ...
    public function showone($IDcancion)
    {
        ...
        $cancion = DB::select("SELECT cancion.titulo AS 'TITULO', cancion.linkLetra AS 'LETRA', cancion.linkVideo AS 'VIDEO', cancion.linkSpotify AS 'MUSICA', cancion.meGusta AS 'MEGUSTA', cancion.noMeGusta AS 'NOMEGUSTA', autor.nombre AS 'AUTOR', album.nombre AS 'ALBUM', album.anio AS 'AÑO', album.discografica AS 'DISCOGRAFICA', genero.descripcion AS 'GENERO', etiqueta.descripcion AS 'ETIQUETAS'
    ...
    public function meGusta($IDcancion)
    {        
    ...
    public function noMeGusta($IDcancion)
    {        
