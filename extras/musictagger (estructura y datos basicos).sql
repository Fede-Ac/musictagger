...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 06-10-2020 a las 20:56:43
...
(1, 'HSDGSDF', 2005, NULL),
(2, 'UKCVXWE', 1995, 'Top Records'),
(3, 'LADARXCZ', 2012, 'Epic Music');
...
(1, 'pedro@gmail.com', 'Pedro', '2009-01-06', '$2y$10$SCuVAZzEhuOg6156NpalkOji/RQ3RGhmMk4nFVXM5dBOGRFh7vYya', 'VHpiPR9Kqsx42pE3WrnxEdfMok85MAtvva9M4zy07Ur6TO5ruBi4oZ5H1MWy', '2020-10-06 18:05:42', '2020-10-06 18:05:42');
...
--
ALTER TABLE `album`
  MODIFY `IDalbum` int(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT de la tabla `autor`
--
ALTER TABLE `autor`
  MODIFY `IDautor` int(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `etiqueta`
  MODIFY `IDetiqueta` int(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
